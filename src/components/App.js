  ...
  async loadBlockchainData(dispatch) {
    ...
    if (window.ethereum ) {
      ...
      try {
        ...
        console.error(e);
        alert('An error occured while loading the block chain')
      }
    } else {
  ...
  async deposit(amount) {
    if (this.state.dbank) {
      try {
        ...
        console.error(`Couldn't deposit amount ${amount}`)
      }
    }
  }
  async withdraw(e) {
    ...
    if (this.state.dbank) {
      try {
        ...
        console.error(`Couldn't withdraw amount`)
      }
    }
  }
                  ...
                  <div>
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <div className="form-group mr-sm-2">
                        <input id="depositAmount" step="0.01" type="number" required ref={(input) => { this.depositAmount = input }}
